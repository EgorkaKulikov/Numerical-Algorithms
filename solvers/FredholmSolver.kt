 ...
 * Линейные интегральные уравнения ФРЕДГОЛЬМА (оператор \mathcal K) в базисе
 * квадратичных минимальных B_phi-сплайнов максимальной гладкости.
 * ============================================================================
 *
 ...
 * ЛИНЕЙНЫХ уравнений Фредгольма:
 *   - II рода (ury2/F2):  u - \mathcal K u = f,   \mathcal K u(t)=\int_a^b K(t,s)u(s) ds;
 *   - I рода  (F1):       \mathcal K u = f  (Wazwaz: (\alpha I + \mathcal K)u_\alpha = f
 *                         <=> u_\alpha - \mathcal K_eff u_\alpha = f/\alpha,
 *                         \mathcal K_eff = -(1/\alpha)\mathcal K, \alpha = 10^{-10}, как в r2.tex).
 *
 * В отличие от эталона `UrysonSolver.kt` (НЕЛИНЕЙНЫЙ Урысон, Ньютон/квази-Ньютон,
 * тихоновская регуляризация для I рода) здесь коллокационные системы ЛИНЕЙНЫ
 * (прямой LU), а F1 решается методом Wazwaz, а НЕ Тихоновым.
 *
 ...
 * 7.KernelF + FredholmOperator 8.ModelProblem 9.SecondKindSolver 10.FirstKindSolver
